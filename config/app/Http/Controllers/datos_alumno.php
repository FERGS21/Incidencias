...
///////////////////////////////traer datos del alumno//////////////////////////////////////////
       ...
       if($periodo_inscrito == 0){
        ...
        return view('evaluacion_docente.Alumnos.datos_alumno',compact('grados','seguro','respuestass','respuesta','datos_u','carreras','estados_alu','municipios','estados_tutor','existe','datos','entidadnac','semestres','datos_t','dat','escuelas','f_nac','edad','ed','genero','sem'));
    }
