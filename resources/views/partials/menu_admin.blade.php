                            ...
                            <ul class="nav navbar-nav navbar-left ">
                                <li class="dropdown bloqueo">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li style=""><a href="{{url('/residentes/carrera')}}">Residentes</a></li>
                                    </ul>
                                </li>
                            </ul>
                                              ...
                                              <ul class="dropdown-menu">
                                                  ...
                                                  @if($ver_carga==false)
                                                      <li><a href="{{url('/carga_academica')}}">Llenar Carga
                                                              Académica</a></li>
                                                  @endif
                                                  <li><a href="{{url('/checar_carga')}}">Revisión Carga Académica</a>
                                                  </li>
                                                      ...
                                                      <li class="dropdown">
                                                          ...
                                                          <ul class="dropdown-menu">
                                                              <li><a href="{{url('/residencia/seguimiento_residencia')}}">Mostrar Seguimiento
                                                                      de Residencia</a></li>
                                                              <li style=""><a href="{{url('/residencia/enviar_documentacion/alumno/')}}">Enviar documentación de Liberación de Residencia</a></li>
