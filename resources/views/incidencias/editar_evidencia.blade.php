...
<div class="row">
    ...
    <div class="col-md-3 col-md-offset-4">
     <div class="panel panel-default">
        <div class="panel-heading">
          <h3> TIPO DE EVIDENCIA</h3>
          <button target="_blank" href="/incidencias/{{$evidencia->arch_evidencia}}" class="btn-success"> <i class=" glyphicon glyphicon-book em128" title="Ver PDF"> </i> VER EVIDENCIA</button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="guardar_mod"class="btn btn-default" data-dismiss="modal">Guardar</button>
                      </div>
